...
# Add Transaction
# -----------------------------
st.set_page_config(page_title="Form Reset Demo")

# ✅ Handle clearing before rendering widgets
...
with c1:
    ...
    service = st.text_input("Service Provided *", key="service_provided")
    addons = st.text_area("Add-ons (optional)", key="addons")
with c2:
